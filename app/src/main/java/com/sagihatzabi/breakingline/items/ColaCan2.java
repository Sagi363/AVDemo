...
public class ColaCan2 extends SagiVectorIcon {

//    private @StyleableRes int[] styleableAttrs = R.styleable.ColaCanView;
    final static @DrawableRes int DRAWABLE_WITH_ANIMATION = R.drawable.ic_can_2;
    final static @DrawableRes int BASE_DRAWABLE_WITHOUT_ANIMATION = R.drawable.ic_can_2;
...
//        mExtras.put(Chili, new FoodExtraState(Chili, false));
    ...
    public ColaCan2(Context context) {
        super(context);
    }

    public static ColaCan2 create(@NonNull final Context context) {
        return new ColaCan2(context);
    }

    public ColaCan2 setType(Type type) {
        this.mType = type;
    ...
    @Override
    public ColaCan2 setSize(int width, int height) {
        return ((ColaCan2) super.setSize(width, height));
    }

    @Override
    public ColaCan2 setName(String name) {
        return ((ColaCan2) super.setName(name));
    }

    @Override
    public ColaCan2 setDescription(String description) {
        return (ColaCan2) super.setDescription(description);
    }

    @Override
    public ColaCan2 addElevation(int elevation) {
        return ((ColaCan2) super.addElevation(elevation));
    }

    @Override
    public ColaCan2 setPriceInDollars(float price) {
        return ((ColaCan2) super.setPriceInDollars(price));
    }
